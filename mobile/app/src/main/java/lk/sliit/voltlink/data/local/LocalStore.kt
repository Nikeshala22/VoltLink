...
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_CAN_CANCEL
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_CAN_MODIFY
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_CREATED
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_END
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_ENERGY
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_HAS_QR
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_ID
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_NIC
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_NO
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_SLOT_ID
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_START
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_STATION_ID
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_STATION_NAME
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_STATUS
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_BOOKING_TYPE
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_ADDRESS
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_EMAIL
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_EXPIRES_AT
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_FULL_NAME
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_PHONE
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_ROLE
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_TOKEN
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_SESSION_USER_ID
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_ADDRESS
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_CAPACITY
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_CITY
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_CLOSE_TIME
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_CODE
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_FREE_SLOTS
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_ID
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_LAT
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_LNG
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_NAME
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_OPEN_TIME
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.COL_STATION_TOTAL_SLOTS
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.TABLE_BOOKING_CACHE
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.TABLE_SESSION
import lk.sliit.voltlink.data.local.VoltLinkDbHelper.Companion.TABLE_STATION_CACHE
import lk.sliit.voltlink.data.remote.OperatingHoursDto
import lk.sliit.voltlink.data.remote.ReservationDto
import lk.sliit.voltlink.data.remote.StationDto
import lk.sliit.voltlink.data.remote.UserDto
