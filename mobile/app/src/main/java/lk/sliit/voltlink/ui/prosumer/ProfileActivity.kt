...
import lk.sliit.voltlink.data.remote.UpdateProfileRequest
import lk.sliit.voltlink.data.remote.UserDto
import lk.sliit.voltlink.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun confirmDeactivationRequest() {
        MaterialAlertDialogBuilder(this)
            ...
            .setMessage(
                "The back-office team will be asked to close your VoltLink account. " +
