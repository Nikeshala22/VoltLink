...
import lk.sliit.voltlink.data.remote.LoginRequest
import lk.sliit.voltlink.databinding.ActivityLoginBinding
    ...
    private fun goToHomeFor(role: String) {
        val destination = when (role) {
            ...
            // would be refused.
                ...
                setBusy(false)
                showError(
                    "Back-office accounts are managed in the VoltLink web application. " +
